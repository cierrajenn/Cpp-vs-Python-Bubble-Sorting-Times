...
debug = True
# TODO: Change these to True when you are ready to run the Python and C++ simulations x
runPython = True
runCpp = True
...
if runCpp:
    # Sort 1000, 2000, 3000, ..., 10000 integers
    for size in range(1000, 10001, 1000):
        # TODO: If debug is true, print statement to show where you are in the program x
        if debug:
            print("Let's see how long it takes C++ to bubble sort", size, "random integers from a file!")

        # TODO: Start the clock x
        tic = time.time()
        ...
        if platform.system() == 'Windows':
            ...
            # If debug is true, print the size of the vector and first and last ten numbers to demonstrate correct sorting
            if debug:
                # I had weird C++ output formatting, so found the decode function at https://www.digitalocean.com/community/tutorials/python-string-encode-decode
        ...
        # TODO: If debug is true, print the time it took C++ to sort the integers x
        if debug:
            print("C++ Bubble Sort finished in %0.6f seconds" % (toc - tic))
        
        # TODO: Add the runtime to the list x
        cppTimes.append(toc - tic)

    # TODO: If debug is true, after all test runs, print the list of C++ runtimes x
    print("C++ times:")
    print(cppTimes)
...
# TODO: Graph Python numbers in red, and C++ numbers in yellow
else:
